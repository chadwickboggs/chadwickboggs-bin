...
#export CATALINA_OPTS_CHARTER="${CATALINA_OPTS_JVM}"
export CATALINA_OPTS_CHARTER="${CATALINA_OPTS_CHARTER} ${CATALINA_OPTS_AWT} ${CATALINA_OPTS_JMX} ${CATALINA_OPTS_ARCHAIUS} ${CATALINA_OPTS_NFOSS} ${CATALINA_OPTS_APP} ${CATALINA_OPTS_LOGBACK_ENV} ${CATALINA_OPTS_ARCHAIUS_ENV} ${CATALINA_OPTS_NFOSS_ENV}"
